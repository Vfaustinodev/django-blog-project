...
#Busca Variaveis de ambiente, tudo que estou criando no .env
#Toda variavel de ambiente retorna um valor string
DEBUG = bool(int(os.getenv('DEBUG', 0)))

ALLOWED_HOSTS = [
    #strip remove espaços vazios, essa Lisht comprehession está buscando os valores da variável de .env e formantando
